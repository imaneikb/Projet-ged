                    ...
                    <div class="tab-pane active" id="profile">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fullName" aria-describedby="fullNameHelp" placeholder="Enter your fullname" value="<?php echo $_SESSION['username']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control autosize" id="bio" placeholder="Email" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;"><p><?php echo $_SESSION['email']; ?></p></textarea>
                            </div>
